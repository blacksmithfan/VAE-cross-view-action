...
def main():
    ...
    #     input_tensor_features= Model.alexnet_lstm(input_x, keep_rate, sequence, lstm_hidden, batch_size)
    ...
    #     output_tensor_features = Model.alexnet_lstm(input_x, keep_rate, sequence, lstm_hidden, batch_size)
    ...
    loss = rec_loss + cross_entropy_loss
        ...
        while step < training_iters:
            ...
            if step % test_step == 0:
                ...
                for _ in range(int(dataset.test_size / batch_size)):
                    batch_tx, batch_ty, _ = dataset.next_batch(batch_size, 'test')
